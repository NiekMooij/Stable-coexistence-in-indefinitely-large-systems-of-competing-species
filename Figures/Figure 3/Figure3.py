...
ax1.set_yticks([0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45], [0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45], fontsize=14)
ax1.grid()
ax1.set_ylim(0.15, 0.43)
...
ax2.set_yticks([0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45], [0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45], fontsize=14)
ax2.set_xlim(0.15, 1)
ax2.grid()
